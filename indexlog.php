...
<head>
	...
	<link rel="shortcut icon" href="images/favicom.jpg">
...
<body >
			...
			<div class="site-navigation">
				<div class="row">
					<div class="col-6 col-lg-3">
						<a href="index.html" class="logo m-0 float-start">UNIVERSE INFO</a>
					</div>
					<div class="col-lg-6 d-none d-lg-inline-block text-center nav-center-wrap">
						...
						<h3 style="color: white;"><?php  echo "Bienvenido  ".$contenido["login"]["email"];{
	...
	<div class="hero overlay">
		...
		<div class="img-bg rellax">
			<img src="690325.jpg" alt="Image" class="img-fluid">
		</div>
		...
		<div class="container" >
			<div class="row align-items-center justify-content-start">
				<div class="col-lg-5">
					...
					<h1 class="heading" data-aos="fade-up">Vivimos en un gran universo, comparta sus imagenes de él</h1>
					<p class="mb-5" data-aos="fade-up">Comparta sus imagenes tomadas del espacio, estrellas, cometas, lo que aporte a la comunidad espacial</p>
		...
		<div class="container">
			<div class="row align-items-center justify-content-between">
				...
				<div class="col-lg-4 order-lg-1">
					...
					<div>
						<h2 class="heading mb-3" data-aos="fade-up" data-aos-delay="100">Explore fabulosas vistas de nuestro universo</h2>

						<p data-aos="fade-up" data-aos-delay="200">Podemos observar increibles vistas como un agujero negro o una estrella colapsando</p>
				...
				<div class="col-lg-9">
					<div class="row">
						<div class="col-lg-8" data-aos="fade-up" data-aos-delay="200">
                            <form id="form" class="form" method="POST" enctype='multipart/form-data' action="compartir.php">
                            
                                <div class="row">
                                    <!-- <div class="col-6 mb-3">
                                        <input type="text"  name="nombre" id="nombre" class="form-control" placeholder="Your Name">
                                    </div> -->
                                    <div class="col-6 mb-3">
                                        <label for="image">Cargue su imagen</label>
                                        <input type="file" name="archivo" id="archivo" class="form-control">
                                        
                                    </div>
                                    <div class="col-6 mb-3">
                                        <label for="nombre">Descripcion</label>
                                        <input type="text" name="nombre" id="nombre" class="form-control" placeholder="Breve descripcion">
                                    </div>
                                    
                                    <!-- <div class="col-12 mb-3">
                                        <textarea name="" id="" cols="30" rows="7" class="form-control" placeholder="Motivo por el cual esta interesado"></textarea>
                                    </div> -->
	...
	<div class="section section-3" data-aos="fade-up" data-aos-delay="100">
		...
		<div class="destination-slider-wrap">
			<div class="destination-slider">
				...
				<div class="destination">
					<div class="thumb">
						<img src="images/QAewHTN (1).jpg" alt="Image" class="img-fluid">
						<div class="price"></div>
					</div>
					<div class="mt-4">
						<h3><a href="#">Paradise Beach, Palawan Island</a></h3>
